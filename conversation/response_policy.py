...
Applies explicit response-style requests while allowing the authoritative Vennela
personality instruction to govern ordinary conversation.
"""
...
class ConversationAdjuster:
    ...
    def adjust(
        ...
        **kwargs: Any,
        ...
        if self.should_be_concise(prompt_clean):
